...
namespace FirstPersonController
{
    ...
    public:
        ...
        virtual void SetMakeCameraChildOfCharacter(const bool&) = 0;
        ...
        virtual AZ::Vector3 GetSceneQueryHitNormal(const AzPhysics::SceneQueryHit&) const = 0;
        virtual AZ::Vector3 GetSceneQueryHitPosition(const AzPhysics::SceneQueryHit&) const = 0;
        virtual float GetSceneQueryHitDistance(const AzPhysics::SceneQueryHit&) const = 0;
        virtual Physics::MaterialId GetSceneQueryHitMaterialId(const AzPhysics::SceneQueryHit&) const = 0;
        virtual AZStd::shared_ptr<Physics::Material> GetSceneQueryHitMaterialPtr(const AzPhysics::SceneQueryHit&) const = 0;
        virtual AZ::Data::Asset<Physics::MaterialAsset> GetSceneQueryHitMaterialAsset(const AzPhysics::SceneQueryHit&) const = 0;
        virtual AZ::Data::AssetId GetSceneQueryHitMaterialAssetId(const AzPhysics::SceneQueryHit&) const = 0;
        virtual float GetSceneQueryHitDynamicFriction(const AzPhysics::SceneQueryHit&) const = 0;
        virtual float GetSceneQueryHitStaticFriction(const AzPhysics::SceneQueryHit&) const = 0;
        virtual float GetSceneQueryHitRestitution(const AzPhysics::SceneQueryHit&) const = 0;
        ...
        virtual bool GetJumpHeldKeepsJumping() const = 0;
        virtual void SetJumpHeldKeepsJumping(const bool&) = 0;
        ...
        virtual void SetJumpHeadIgnoreDynamicRigidBodies(const bool&) = 0;
        virtual AZStd::string GetHeadCollisionGroupName() const = 0;
        virtual void SetHeadCollisionGroupByName(const AZStd::string&) = 0;
        virtual AzPhysics::SceneQuery::ResultFlags GetSceneQueryHitResultFlags(const AzPhysics::SceneQueryHit&) const = 0;
        ...
        virtual float GetSprintTotalCooldownTime() const = 0;
        virtual void SetSprintTotalCooldownTime(const float&) = 0;
        virtual float GetSprintCooldownTimer() const = 0;
        virtual void SetSprintCooldownTimer(const float&) = 0;
        ...
        virtual bool GetCrouchWhenNotGrounded() const = 0;
        ...
        virtual AZ::EntityId GetEntityIdByStringNetId(const AZStd::string&) const = 0;
#endif
    ...
    public:
        ...
        void OnNetworkFPCAutonomousClientActivated(const AZ::EntityId& entityId) override
        {
            Call(FN_OnNetworkFPCAutonomousClientActivated, entityId);
        }
